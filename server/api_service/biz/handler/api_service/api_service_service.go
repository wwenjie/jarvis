...
import (
	...
	api_service "server/api_service/biz/model/api_service"
...
func CreateSession(ctx context.Context, c *app.RequestContext) {
	var err error
	var req api_service.CreateSessionReq
	err = c.BindAndValidate(&req)
	if err != nil {
		c.String(consts.StatusBadRequest, err.Error())
		return
...
func EndSession(ctx context.Context, c *app.RequestContext) {
	var err error
	var req api_service.EndSessionReq
	err = c.BindAndValidate(&req)
	if err != nil {
		c.String(consts.StatusBadRequest, err.Error())
		return
...
func AddDocument(ctx context.Context, c *app.RequestContext) {
	...
	var err error
	var req api_service.AddDocumentReq
	err = c.BindAndValidate(&req)
	if err != nil {
...
func SearchDocument(ctx context.Context, c *app.RequestContext) {
	var err error
	var req api_service.SearchDocumentReq
	err = c.BindAndValidate(&req)
	if err != nil {
		c.String(consts.StatusBadRequest, err.Error())
		return
...
func CreateUser(ctx context.Context, c *app.RequestContext) {
	var err error
	var req api_service.CreateUserReq
	err = c.BindAndValidate(&req)
	if err != nil {
		c.String(consts.StatusBadRequest, err.Error())
		return
...
func ListDocument(ctx context.Context, c *app.RequestContext) {
	var err error
	var req api_service.ListDocumentReq
	err = c.BindAndValidate(&req)
	if err != nil {
		c.String(consts.StatusBadRequest, err.Error())
		return
...
func GetSession(ctx context.Context, c *app.RequestContext) {
	var err error
	var req api_service.GetSessionReq
	err = c.BindAndValidate(&req)
	if err != nil {
		c.String(consts.StatusBadRequest, err.Error())
		return
...
func GetSessionList(ctx context.Context, c *app.RequestContext) {
	var err error
	var req api_service.GetSessionListReq
	err = c.BindAndValidate(&req)
	if err != nil {
		c.String(consts.StatusBadRequest, err.Error())
		return
...
func DeleteDocument(ctx context.Context, c *app.RequestContext) {
	var err error
	var req api_service.DeleteDocumentReq
	err = c.BindAndValidate(&req)
	if err != nil {
		c.String(consts.StatusBadRequest, err.Error())
		return
...
func AddMemory(ctx context.Context, c *app.RequestContext) {
	var req api_service.AddMemoryReq
	if err := c.BindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, api_service.BaseRsp{
			Code: 1,
	...
	client, exists := c.Get("rag_svr_client")
	if !exists {
		c.JSON(http.StatusInternalServerError, api_service.BaseRsp{
			Code: 1,
			Msg:  "客户端未初始化",
		})
		return
	...
	c.JSON(http.StatusOK, api_service.AddMemoryRsp{
		Code:     resp.Code,
		Msg:      resp.Msg,
...
func GetMemory(ctx context.Context, c *app.RequestContext) {
	...
	c.JSON(http.StatusOK, api_service.GetMemoryRsp{
...
func SearchMemories(ctx context.Context, c *app.RequestContext) {
	...
	// 转换 Memories 类型
	memories := make([]*api_service.Memory, len(resp.Memories))
	for i, m := range resp.Memories {
		memories[i] = &api_service.Memory{
			MemoryId:    m.MemoryId,
			UserId:      m.UserId,
			Content:     m.Content,
	...
	c.JSON(http.StatusOK, api_service.SearchMemoriesRsp{
		Code:     uint32(resp.Code),
		Msg:      resp.Msg,
		Memories: memories,
	})
...
func DeleteMemory(ctx context.Context, c *app.RequestContext) {
	...
	var req api_service.DeleteMemoryReq
	if err := c.BindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, api_service.BaseRsp{
			Code: 1,
			Msg:  fmt.Sprintf("解析请求失败: %v", err),
	...
	c.JSON(http.StatusOK, api_service.DeleteMemoryRsp{
		Code: resp.Code,
		Msg:  resp.Msg,
	})
}
...
func AddChatRecord(ctx context.Context, c *app.RequestContext) {
	var req api_service.AddChatRecordReq
	if err := c.BindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, api_service.BaseRsp{
			Code: 1,
			Msg:  fmt.Sprintf("解析请求失败: %v", err),
	...
	c.JSON(http.StatusOK, api_service.AddChatRecordRsp{
...
func GetChatRecords(ctx context.Context, c *app.RequestContext) {
	...
	// 转换 Records 类型
	records := make([]*api_service.ChatRecord, len(resp.Records))
	for i, r := range resp.Records {
		records[i] = &api_service.ChatRecord{
	...
	c.JSON(http.StatusOK, api_service.GetChatRecordsRsp{
		Code:     int32(resp.Code),
		Msg:      resp.Msg,
		Total:    resp.Total,
		Page:     resp.Page,
...
func GetWeather(ctx context.Context, c *app.RequestContext) {
	var err error
	var req api_service.GetWeatherReq
	err = c.BindAndValidate(&req)
	if err != nil {
		c.String(consts.StatusBadRequest, err.Error())
		return
...
func GetHourlyWeather(ctx context.Context, c *app.RequestContext) {
	var err error
	var req api_service.GetHourlyWeatherReq
	err = c.BindAndValidate(&req)
	if err != nil {
		c.String(consts.StatusBadRequest, err.Error())
		return
...
func GetDailyWeather(ctx context.Context, c *app.RequestContext) {
	var err error
	var req api_service.GetDailyWeatherReq
	err = c.BindAndValidate(&req)
	if err != nil {
		c.String(consts.StatusBadRequest, err.Error())
		return
